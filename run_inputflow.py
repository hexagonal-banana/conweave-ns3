...
def main():
    ...
    parser.add_argument('--paralet_k', dest='paralet_k', action='store',
                        type=int, default=1, help="paralet argument k (default: 1)")
    parser.add_argument("--flow_file",dest='flow_file',action='store',
                        default='NULL',help="input flow file")
    ...
    letflow_timeout=args.letflow_timeout
    paralet_on=args.paralet_on
    paralet_k=args.paralet_k
